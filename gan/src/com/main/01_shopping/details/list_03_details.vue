<template>
  <div id="app">
    ...
    <div class="input">
      <span class="glyphicon glyphicon-search" id="magnifier"></span>
      <input type="text" name="" id="" value="" placeholder="搜索你喜欢的商品、店铺"/>
    </div>
...
export default {
  ...
  created(){
      var url="./src/com/main/json/list_03_details.json"
